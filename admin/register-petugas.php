<?php
    ...
    if(isset($_POST["register"])){
        if(registerpetugas($_POST) > 0){
            echo "<script>
                    alert('New Account Has Been Successfully Registered');
                  </script>";
        }else{
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- daftar laporan -->
                        <h1 class="h3 mb-4 text-gray-800">Registrasi</h1>
                        <div class="col-lg-6">
                            <form action="" method="POST" class="mt-4">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="nama_petugas" name="nama_petugas" placeholder="Nama Lengkap">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <select id="level" name="level" class="form-select">
                                        <option class="disabled">Level</option>
